...
{
    public Transform aroundPoint;//вокруг какого объекта крутитьс€
    public float circleInSecond = 1f;//кругов в секунду

    public float offsetSin = 1; //если значени€ не 1, то будет овальное смещение
